...
%(217) 305-2385  \hfill andrewryh@gmail.com    
    ...
    \section{\mysidestyle Research\\Interests}
		Advanced nuclear systems modeling/optimization, safety and transient analysis, 
	   reactor physics, uncertainty quantification
	...
	\begin{list2}
	\item Developing methods for steady-state neutronics calculations to support Natrium project
	\end{list2}
