...
\begin{resume}
    ...
    \begin{list2}
        \item Advanced online fuel reprocessing simulation for thorium-fueled MSBR
        \item Advisor:  Professor Kathryn D. Huff
    \end{list2}\vspace{-1.5mm}
    \section{\mysidestyle MSc}
    ...
    \section{\mysidestyle Honors and\\Awards}
        American Nuclear Society, John and Muriel Landis Scholarship\hfill \textbf{2017--2018}\vspace{.5mm}\\%
    ...
    \section{\mysidestyle Journal\\Publications}
      \begin{bibenum}
       \item Lindsay, A., Ridley, G., \textbf{Rykhlevskii, A.}, Huff, K. ``Introduction to 
               ...
               Reactors'',  \textsl{Annals of Nuclear Energy}, vol. 114, Pages 530 - 540, 2018. \url{doi.org/10.1016/j.anucene.2017.12.025}
...
%__________________________________________________________________________________________________________________
    ...
    %\textbf{<++>}, <++>, \emph{<++>}.  \hfill\textbf{<+mo+> <+date+>, <+yy+>}\\
      ...
      \textbf{Blue Waters Symposium 2018}. \emph{Panel}.  \hfill\textbf{Jun 04, 2018}\\
        %__________________________________________________________________________________________________________________
    % Teaching Experience
...
%    \hfill BS--University of Tennessee, Knoxville\\ 
    ...
    \section{\mysidestyle Scientific\\Computing\\Skills}
                ...
                \textbf{Other Tools} \hfill Serpent, MOOSE, MathCAD, MATLAB, Octave, ANSYS, PyNE, SCALE\vspace{.5mm}%
    %__________________________________________________________________________________________________________________
