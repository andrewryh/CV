...
%519 Spruce Rd, Bolingbrook, IL 60440  \hfill 
%(217) 305-2385  \hfill andrewryh@gmail.com    

    Nuclear Engineer \hfill mobile: (217) 305-2385 \vspace{0mm}\\\vspace{0mm}
    \hspace{-1.35mm}\textsl{Argonne National Laboratory}       \hfill andrewryh@gmail.com    
    ...
    \section{\mysidestyle Research\\Interests}
		Advanced nuclear systems modeling/optimization, scientific software development, 
	   machine learning and data-driven optimization, uncertainty quantification
    ...
    \textbf{Argonne National Laboratory}, Lemont, IL\\
		...
		\hfill \textbf{Jun 2021 -- April 2024}\\		
...
\vspace{2mm} % add this back if you return to Refereed Journal..
    ...
    \begin{bibenum}
     ...
     ``Impact of ENDF/B-VIII.0 library on BR2 depletion calculations for irradiation testing of low-    	enriched uranium silicide dispersion fuel.'' (submitted) \textbf{Transactions of the American Nuclear Society Winter 
...
\end{bibenum}
    ...
    \makebox[0.2\textwidth][l]{PhD - 2022} 
    \hfill Mentor\\
