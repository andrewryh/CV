...
%Foreign address: Bykovskaya 10-40, Podolsk, Russian Federation, 142111      
    ...
    \section{\mysidestyle Research\\Interests}
		Molten Salt Reactors physic, neutron transport, Monte Carlo, 
    ...
    \textbf{University of Illinois at Urbana-Champaign}, Urbana, IL\\
		\textsl{Graduate Research Assistant, Advanced Reactors and Fuel Cycles Group} \hfill \textbf{Aug 2016 -- Present}\\
                ...
                reactor neutronics and safety analysis
                \item Investigating load-following capabilities for MSRs
                \item Neutronic calculations for MSRs using Monte-Carlo code 
                Serpent
				\item Creating MSR models in multiphysics environment MOOSE
				\item Developed problem-oriented Nuclear Data libraries using 
				Serpent and SCALE
                \end{list2}
