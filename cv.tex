...
%Foreign address: Bykovskaya 10-40, Podolsk, Russian Federation, 142111      
    ...
    \section{\mysidestyle Research\\Interests}
		Physics of advanced reactor systems, design optimization, neutron transport, depletion calculation, fuel cycle performance, validation and verification, code optimization, uncertainty quantification, high performance computing
                %
    %__________________________________________________________________________________________________________________
...
\vspace{2mm} % add this back if you return to Refereed Journal..
    ...
    \item \textbf{Rykhlevskii, A.}, Betzler, B.R., Worrall, A., Huff, K. ``Fuel Cycle Performance of Fast Spectrum Molten Salt Reactors designs.'' \textbf{Proceedings of M\&C 2019 - International Conference on Mathematics \& Computational Methods Applied to Nuclear Science and Engineering.} 
