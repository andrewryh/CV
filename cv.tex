...
%Foreign address: Bykovskaya 10-40, Podolsk, Russian Federation, 142111      
    ...
    Postdoctoral Associate \hfill mobile: (217) 305-2385 
    ...
    Engineering}\hfill \textbf{ Aug 2016 -- Jul 
    ...
    \textbf{Argonne National Laboratory}, Lemont, IL\\
		\textsl{Postdoctoral Associate, Core Design \& Safety Analysis Group} 
		\hfill \textbf{Aug 2020 -- Present}\\
\vspace{-4mm}\begin{list2}
	\item Performing neutronics calculation to reduce enrichment in research 
	and test reactors
\end{list2}
...
\vspace{2mm} % add this back if you return to Refereed Journal..
	...
	\begin{bibenum}
		...
		double-zone thorium molten salt reactor (SD-TMSR). Part I: Design 
		development, material selection, and worth analysis.''
		Submitted to \textbf{Progress in Nuclear Energy}, March 2020.		
	\end{bibenum}
